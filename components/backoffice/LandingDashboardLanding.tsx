...
const quickLinks = [
  ...
  { href: '/learn/vip', title: 'View VIP Access', desc: 'Check your VIP status and premium member benefits.', icon: Star, accent: 'lime' },
]
...
export function LandingDashboardLanding() {
