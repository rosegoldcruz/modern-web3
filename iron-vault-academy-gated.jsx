 ...
 *
 * GATED VARIANT — for new investors / public-facing funnel.
 * - Requires Privy login.
 * - Checks /api/check-payment for which modules are unlocked.
 * - Unowned modules show an "UNLOCK — $X" CTA linking to /learn/pay?module=N.
 * - Module sequencing still enforced (must pass quiz AND own next module).
 * - Usage: this is the default — app/learn/page.tsx already imports
 *   IronVaultAcademy from "@/iron-vault-academy-v2"
 *   Swap that import to "@/iron-vault-academy-gated" when you rename files.
 */
...
const MODULE_PRICES = { 1: 100, 2: 25, 3: 25, 4: 25, 5: 25, 6: 25 };
...
const MODULES = [
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: "body", text: "Modern money is fiat currency. It has value because the government says it does — not because it's backed by gold, silver, or anything tangible. The U.S. officially left the gold standard in 1971." },
          { type: "callout", text: "In 1913, the Federal Reserve was created. Most Americans believe the Fed is a government agency. It is not. It is a private banking institution — owned by private member banks — that controls the U.S. money supply." },
          ...
          { type: "body", text: "Money is a tool. Not your identity, your worth, or your security. The wealthy treat it as a system to be understood and leveraged." },
      ...
      },
      {
        ...
        content: [
          ...
          { type: "body", text: "What cost $1 in 1913 costs approximately $31 today. Your grandparents' savings — destroyed. Your parents' retirement — eroding. Yours? Already shrinking." },
          { type: "callout", text: "This is called the Cantillon Effect. When new money is created, it flows first to banks and large institutions, who spend it before prices rise. The wealthy gain. The working class loses. Every. Single. Time." },
          { type: "vault", title: "VAULT SECRET: How the Wealthy Beat Inflation", text: "They don't hold dollars. They hold assets. Real estate, businesses, commodities, equity — things that rise in price WITH inflation. A savings account earning 0.5% when inflation runs 7% is not saving — it's a slow bleed." },
          { type: "action", text: "Look up the price of a median home, a gallon of milk, and a college degree in 1971 vs today." }
        ]
      },
      {
        title: "Budgeting — But Make It Real",
        content: [
          { type: "quote", text: "It's not about how much money you make, but how much money you keep.", author: "Robert Kiyosaki" },
          { type: "heading", text: "A budget is a plan — not a cage" },
          { type: "body", text: "The 50/30/20 rule is a starting framework — 50% needs, 30% wants, 20% savings and debt reduction. But the wealthy route income through entities and structure their life so that expenses become deductible." },
          { type: "callout", text: "A W-2 employee earns money, pays taxes, then spends what's left. A business owner earns money, spends on legitimate business expenses, then pays taxes on what's left. Same income. Radically different tax outcome." },
          { type: "vault", title: "VAULT SECRET: The LLC Expense Play", text: "When you own an LLC, your car, phone, home office, certain meals, travel, education, and software may become deductible business expenses. A $1,000 expense with a 30% tax rate effectively costs you $700." },
          { type: "action", text: "Track every dollar for 30 days. How many expenses could be legitimate business deductions if you had an LLC?" }
        ]
      },
      {
        ...
        content: [
          ...
          { type: "list", items: ["Assets: rental property, businesses, investments, intellectual property, systems that generate cash", "Liabilities: high-interest debt, depreciating vehicles, luxury items financed on credit"] },
          { type: "body", text: "The middle class is sold the idea that their house is their biggest asset. In most cases, a primary residence is a liability — it costs money in taxes, maintenance, and mortgage interest every single month." },
          { type: "vault", title: "VAULT SECRET: Buy, Borrow, Die", text: "Step 1: Buy appreciating assets. Step 2: Never sell them — borrow against them instead. Loans are not taxable income. Step 3: Die. When assets transfer to heirs, the cost basis resets — eliminating all accumulated capital gains. The wealthy pay zero tax on a lifetime of gains. This is legal. This is documented." },
          { type: "action", text: "List everything you own. Mark each: Asset (cash flow positive), Liability (cash flow negative), Neutral." }
        ]
      },
      {
        ...
        content: [
          ...
          { type: "body", text: "The majority of Americans cannot cover a $1,000 emergency without going into debt. Payday lenders charge 400% APR. Credit card companies earn billions from minimum payment traps." },
          { type: "callout", text: "Cash margin creates decision-making power. When you have reserves, you can walk away from bad jobs, bad deals, and bad situations. When you have none, you stay trapped." },
          ...
          { type: "vault", title: "VAULT SECRET: Where to Actually Keep It", text: "High-Yield Savings Accounts through online banks like Marcus, Ally, or SoFi offer 4-5% APY with full FDIC insurance. The big banks advertise heavily and count on your inertia. Move the money. It's a 10-minute account setup." },
      ...
      },
      {
        ...
        content: [
          ...
          { type: "callout", text: "The wealthy think in decades. The middle class thinks in months. The poor think in days. Time horizon is one of the greatest wealth separators that nobody talks about." },
          { type: "vault", title: "VAULT SECRET: The Entity Mindset", text: "Stop thinking about building a bank account. Start thinking about building an entity — a legal structure that holds assets, receives income, and creates separation between you and your finances. Their entities get the tax breaks. Their entities borrow money." },
          { type: "action", text: "Write your 30-day, 12-month, and 5-year goals — framed around building an entity or system, not just saving a number." }
        ]
      }
    ],
    quiz: [
  ...
  },
  {
    ...
    lessons: [
      { title: "The Velocity of Money", content: [{ type: "heading", text: "The same dollar can create vastly different economic impact depending on how fast it moves" }, { type: "body", text: "A dollar spent at a local business circulates more times than a dollar spent at a large corporation. Economic energy is not just about amount — it's about speed." }, { type: "callout", text: "When the Fed injects money through large banks, velocity drops. When money reaches individuals who spend locally, velocity spikes. Same dollar. Completely different economic outcome." }, { type: "vault", title: "VAULT SECRET: Why Local Business Ownership Compounds", text: "A business owner who spends locally, hires locally, and reinvests locally creates a multiplier effect. Every dollar they circulate comes back to them in some form — through customers, partnerships, and property values." }, { type: "action", text: "Track where your last 10 purchases went. How much of your spending stays in your community versus leaves it?" }] },
      { title: "Asymmetric Information", content: [{ type: "heading", text: "One party knows more than the other — and the side with less information always pays the tax" }, { type: "body", text: "Insurance companies know more about risk than you do. Car dealerships know more about vehicle value. This information gap is the structural advantage that allows these industries to extract value from every transaction." }, { type: "callout", text: "The house always wins not because of luck — but because it has more information, better models, and longer time horizons than the average participant." }, { type: "vault", title: "VAULT SECRET: How to Close the Gap", text: "Every hour you spend learning an industry's mechanics reduces the tax you pay to participate in it. Education is not self-improvement. It is arbitrage against the information gap." }, { type: "action", text: "Pick one financial product you currently use. Spend one hour learning exactly how the provider makes money from you." }] },
      { title: "Arbitrage", content: [{ type: "heading", text: "Buy where it's cheap, sell where it's expensive — but the deeper lesson goes further" }, { type: "body", text: "Markets are never perfectly efficient. Gaps always exist — in price, in information, in timing, in geography. The people who spot those gaps and act on them extract the value others leave behind." }, { type: "callout", text: "Geographic arbitrage: earning income from a high-cost market while living in a low-cost one. Labor arbitrage. Time arbitrage: building assets today that pay when your time is more scarce." }, { type: "vault", title: "VAULT SECRET: Attention Arbitrage", text: "Right now, certain platforms and asset classes are underpriced in terms of attention. The people who build positions before they become crowded will extract the same value early internet adopters did." }, { type: "action", text: "Identify one market, skill, or platform where you have more knowledge than average. How could you monetize that gap in the next 90 days?" }] },
      { title: "Opportunity Cost", content: [{ type: "heading", text: "Every choice has a hidden price — the value of the next best alternative" }, { type: "body", text: "Most people only calculate the cost of action. Almost nobody calculates the cost of inaction. Keeping money in a savings account earning 0.5% when inflation runs 4% has a real cost." }, { type: "callout", text: "Procrastination is the most expensive habit on earth — not because of the time lost, but because of the compounding returns never started." }, { type: "vault", title: "VAULT SECRET: The Opportunity Cost of Employment", text: "A $75,000 salary feels different when you calculate its opportunity cost. The same 40 hours directed toward building a scalable asset has a fundamentally different ceiling. Employment trades time for money linearly. Ownership compounds." }, { type: "action", text: "Calculate the opportunity cost of your current largest financial decision. What are you giving up by not doing the next best alternative?" }] },
      { title: "Elasticity of Demand", content: [{ type: "heading", text: "Some prices can rise without killing demand. Some collapse instantly." }, { type: "body", text: "Gas, rent, and medication are inelastic — demand holds even as price rises. Luxury goods and discretionary spending are elastic — demand drops quickly when price moves." }, { type: "callout", text: "The most durable businesses in history sell inelastic products. Landlords hold pricing power because people cannot opt out of shelter." }, { type: "vault", title: "VAULT SECRET: Build Inelastic Income", text: "The goal of sophisticated wealth strategy is to build income streams that are inelastic — where your customers have no easy alternative to paying you. Rental income, proprietary software, essential services, specialized expertise." }, { type: "action", text: "List your current income sources. For each: how easy is it for the payer to replace you?" }] },
      { title: "The Principal-Agent Problem", content: [{ type: "heading", text: "The person making decisions is not the person who bears the consequences" }, { type: "body", text: "Employees versus owners. Politicians versus citizens. Financial advisors versus clients. The agent makes decisions with other people's money — and their incentives are rarely perfectly aligned." }, { type: "callout", text: "A financial advisor paid on commission recommends products that pay the highest commission. A fund manager paid on AUM grows the fund even when returns are poor." }, { type: "vault", title: "VAULT SECRET: Align Incentives or Exit", text: "The solution to the principal-agent problem is either aligning incentives — equity, performance-based compensation, skin in the game — or removing the agent entirely. Self-directed investing removes the advisor. Business ownership removes the employer." }, { type: "action", text: "Identify every agent currently making decisions that affect your financial life. Write their actual incentive." }] },
      { title: "Animal Spirits", content: [{ type: "quote", text: "The market can remain irrational longer than you can remain solvent.", author: "John Maynard Keynes" }, { type: "heading", text: "Human emotion drives markets more than math" }, { type: "body", text: "Keynes called it animal spirits — confidence, fear, and euphoria move capital faster and further than any spreadsheet. This is not a flaw in markets. It is their defining characteristic." }, { type: "callout", text: "Bitcoin did not rise to $60,000 because of a discounted cash flow model. It rose because millions of people believed it would. Understanding this protects you from being swept up in it." }, { type: "vault", title: "VAULT SECRET: Use Sentiment as a Signal", text: "When everyone is euphoric, risk is highest. When everyone is panicking, opportunity is greatest. The investors who built generational wealth in 2008 and March 2020 moved opposite to the dominant emotional current." }, { type: "action", text: "Find an asset class currently experiencing extreme fear or euphoria. Write the rational case for why the emotional extreme may be creating a mispricing." }] },
      { title: "Marginal Analysis", content: [{ type: "heading", text: "The next unit of effort, cost, or output matters more than the total" }, { type: "body", text: "Businesses live or die on the margin. The question is never 'what did this cost in total?' The question is 'what does one more unit cost, and what does it produce?'" }, { type: "callout", text: "A rental property generating $500 per month net is attractive. What does acquiring one more property cost — in time, capital, and management burden? The answer determines whether to scale or consolidate." }, { type: "vault", title: "VAULT SECRET: Your Marginal Hour", text: "The marginal value of your time changes as your income grows. The hour spent building a system that runs without you pays compounding returns indefinitely." }, { type: "action", text: "Calculate the marginal return on your last three major decisions. Was the margin improving or declining?" }] },
      { title: "The Accelerator Effect", content: [{ type: "heading", text: "When the economy grows, investment accelerates — not linearly, but exponentially" }, { type: "body", text: "Small increases in consumer demand trigger disproportionately large increases in business investment. A 10% increase in demand might trigger a 30% increase in capital expenditure." }, { type: "callout", text: "This same principle applies to your personal financial trajectory. Small improvements in income, savings rate, and investment return compound into exponentially different outcomes over a decade." }, { type: "vault", title: "VAULT SECRET: Position Before the Acceleration", text: "Every major technology cycle has an acceleration phase where early participants benefit disproportionately. The window to position before acceleration is always shorter than it looks in hindsight." }, { type: "action", text: "Identify one technology or market currently in early adoption. Write the case for why acceleration may be coming." }] },
      { title: "The Circular Flow of Money", content: [{ type: "heading", text: "Households → businesses → government → banks → back to households" }, { type: "body", text: "This loop is the blueprint of the entire economy. Understanding it shows where value leaks, where it accumulates, and where power concentrates." }, { type: "callout", text: "Banks sit at the center of this loop by design. Every transaction, every loan, every investment passes through the banking system — which extracts a fee at each point." }, { type: "vault", title: "VAULT SECRET: Position Yourself in the Flow", text: "The goal of sophisticated wealth building is to insert yourself into the circular flow as a recipient rather than just a participant. Rental income. Royalties. Interest. Dividends. Token distributions from real asset revenue." }, { type: "action", text: "Draw your personal circular flow. Where does money enter? Where does it exit? Where are you losing it to intermediaries?" }] }
    ],
    quiz: [
  ...
  },
  {
    ...
    lessons: [
      { title: "How Banks Really Work — Follow the Money", content: [{ type: "quote", text: "Banking was conceived in iniquity and born in sin.", author: "Josiah Stamp, Former President of the Bank of England" }, { type: "heading", text: "Fractional Reserve Banking" }, { type: "body", text: "Here is what your bank does with your deposit: it keeps a fraction as reserves and loans out the rest — often 10x what it actually holds. They charge interest on money that didn't exist before you walked in." }, { type: "callout", text: "Banks earn the spread: they pay you 0.5% on your savings and charge borrowers 7-25% on loans. The difference — your money, their profit." }, { type: "vault", title: "VAULT SECRET: Business Banking Strategy", text: "Never mix personal and business finances. Open a dedicated business checking account the moment you form an LLC. This creates legal separation, builds a banking relationship for future credit, and allows you to show business revenue history for loans." }, { type: "action", text: "Check your bank accounts: what interest are you earning? What fees are you paying? Calculate fees paid over the last 12 months." }] },
      { title: "Stocks, Bonds & Index Funds — The Honest Truth", content: [{ type: "quote", text: "The stock market is a device for transferring money from the impatient to the patient.", author: "Warren Buffett" }, { type: "heading", text: "Three categories — and what the wealthy actually do" }, { type: "body", text: "Stocks: fractional ownership of a company. Bonds: lending money to governments or corporations. Index funds: diversified exposure to a market segment without picking individual stocks." }, { type: "callout", text: "Buffett recommends low-cost S&P 500 index funds for most Americans. Yet the financial advisory industry makes billions selling actively managed funds that underperform the index 85% of the time." }, { type: "vault", title: "VAULT SECRET: What the Wealthy Actually Hold", text: "The ultra-wealthy primarily build wealth through ownership — of businesses, real estate, and intellectual property that generates cash flow. The stock market is where they park excess capital." }, { type: "action", text: "Research: compare a target-date retirement fund's fees vs a Vanguard S&P 500 index fund over 30 years on $100,000." }] },
      { title: "Real Estate — The Wealth Machine They Can't Print More Of", content: [{ type: "quote", text: "Real estate cannot be lost or stolen, nor can it be carried away.", author: "Franklin D. Roosevelt" }, { type: "heading", text: "Four ways real estate builds wealth simultaneously" }, { type: "list", items: ["Cash Flow — rental income above all expenses", "Appreciation — values historically rise over time", "Loan Paydown — tenants effectively pay your mortgage", "Tax Advantages — depreciation, deductions, and deferrals"] }, { type: "callout", text: "The government incentivizes real estate ownership more than any other asset class. Knowing these incentives and using them is what every wealthy real estate investor does by default." }, { type: "vault", title: "VAULT SECRET: 1031 Exchange & Cost Segregation", text: "A 1031 Exchange lets you sell investment real estate and roll ALL proceeds into a new property — deferring capital gains taxes indefinitely. Cost segregation creates massive paper losses that offset real income. A $1M property might generate $150K+ in paper losses in year one. Legal. Used by every sophisticated real estate investor." }, { type: "action", text: "Research median rent prices in your city vs median mortgage payments on similar properties. Is there cash flow potential in your market?" }] },
      { title: "Retirement Accounts — The Hidden Power Most People Ignore", content: [{ type: "heading", text: "The government is actually on your side here" }, { type: "body", text: "401(k), Traditional IRA, and Roth IRA accounts provide tax advantages that compound significantly over decades. Employer 401(k) matching is literally free money — yet millions of Americans leave it unclaimed." }, { type: "callout", text: "The Roth IRA is arguably the most powerful wealth-building vehicle available to people under a certain income threshold. Money grows completely tax-free. Withdrawals in retirement are tax-free." }, { type: "vault", title: "VAULT SECRET: Backdoor Roth & Roth Conversion Ladder", text: "High earners use the 'Backdoor Roth' — contributing to a Traditional IRA and immediately converting it. Completely legal. Used by thousands of high-income earners annually. The Roth Conversion Ladder creates tax-free income streams in early retirement." }, { type: "action", text: "Find out: does your employer offer a 401(k) match? Are you capturing the full match? Calculate the exact dollar amount you're leaving on the table annually." }] },
      { title: "Credit — The Score That Controls Your Access to Capital", content: [{ type: "heading", text: "Credit is not debt. It's leverage." }, { type: "body", text: "A strong credit profile gives you access to capital at low interest rates — which means you can borrow money cheaply and deploy it into assets that return more than the cost of borrowing." }, { type: "callout", text: "Poor credit doesn't just cost you on loans. It costs you on car insurance, rental applications, security deposits, and business partnerships. A low score is a tax on everything." }, { type: "vault", title: "VAULT SECRET: Business Credit is a Separate System", text: "A new LLC can begin building business credit through a DUNS number, net-30 vendor accounts (Uline, Grainger, Quill), and a business credit card. Within 12-24 months, a properly structured business can access credit lines that have nothing to do with your personal SSN." }, { type: "action", text: "Pull your free credit report at AnnualCreditReport.com. Identify every negative item and look up the statute of limitations for removal in your state." }] },
      { title: "Comparing Wealth Paths — Employee vs Owner", content: [{ type: "quote", text: "The problem with the rat race is that even if you win, you're still a rat.", author: "Lily Tomlin" }, { type: "heading", text: "The system taxes labor. It subsidizes ownership." }, { type: "body", text: "W-2 employees pay income tax, Social Security tax (6.2%), and Medicare tax (1.45%) — all before they spend a dollar. Business owners pay themselves after deducting legitimate business expenses." }, { type: "callout", text: "An S-Corp owner can pay themselves a reasonable salary and take additional profit as distributions not subject to self-employment tax. On $150,000 in business income, the tax difference vs W-2 can be $10,000-$20,000 annually." }, { type: "vault", title: "VAULT SECRET: The Solo 401(k) for Self-Employed", text: "A self-employed individual or LLC owner can contribute to a Solo 401(k) as BOTH employer and employee — up to $66,000+ annually. A W-2 employee is limited to $23,000. Same income. Completely different outcome." }, { type: "action", text: "Calculate the difference in take-home pay between earning $100,000 as a W-2 employee vs a properly structured S-Corp in your state." }] }
    ],
    quiz: [
...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .iv-card.locked.purchasable{opacity:1;cursor:default;}
  ...
  .b-buy{color:#C9A227;background:rgba(201,162,39,0.1);border:1px solid rgba(201,162,39,0.3);}
  ...
  .iv-unlock-cta{
    margin-top:16px;display:block;width:100%;border:none;border-radius:3px;padding:14px;
    background:#AAFF00;color:#080808;font-family:'Bebas Neue',sans-serif;
    font-size:15px;letter-spacing:2px;cursor:pointer;transition:all 0.2s;
    text-decoration:none;text-align:center;
  }
  .iv-unlock-cta:hover{background:#BFFF33;}
...
function ContentBlock({b}){
  switch(b.type){
    case "quote": return (<div className="c-quote"><blockquote>"{b.text}"</blockquote><cite>— {b.author}</cite></div>);
    ...
    case "list": return (<div className="c-list">{b.items.map((item,i)=><div key={i} className="c-list-item">{item}</div>)}</div>);
    case "action": return (<div className="c-action"><span className="c-action-label">ACTION</span><span className="c-action-text">{b.text}</span></div>);
    case "vault": return (
      <div className="c-vault">
        <div className="c-vault-label"><span>🔐</span><span>VAULT SECRET</span><span style={{flex:1,height:'1px',background:'linear-gradient(90deg,rgba(201,162,39,0.3),transparent)',marginLeft:8}}/></div>
...
export default function IronVaultAcademyGated(){
  ...
  useEffect(()=>{
    ...
    fetch("/api/check-payment",{
      ...
      .then(data=>{
        ...
        // If user has nothing unlocked at all, send them to pay
        if(!data?.paid && unlocked.length === 0){
          router.replace("/learn/pay");
        }
      })
      .catch(()=>{ if(!cancelled) router.replace("/learn/pay"); });
  ...
  const isOwned = (i) => modulesUnlocked.includes(`module_${i+1}`);

  /**
   * GATED VARIANT: Module access rules
   * - Module must be purchased (isOwned)
   * - Module 2+ must also have previous module quiz passed
   * - Unowned modules show purchase CTA
   */
  function modStatus(i){
    if(!isOwned(i)) return "buy";
    if(i > 0 && !progress[i-1].passed) return "locked"; // owned but sequential lock
  ...
  function startQuiz(){ setAnswers({});setCurQ(0);setRevealed(false);setView("quiz"); }
    ...
    return(
      <div className="iv">
        ...
        <div style={{minHeight:"100vh",display:"grid",placeItems:"center",padding:"40px 20px",position:"relative",zIndex:1}}>
          <div style={{maxWidth:480,width:"100%",background:"#0F0F0F",border:"1px solid rgba(123,47,190,0.3)",borderRadius:6,padding:"48px 40px",textAlign:"center"}}>
            ...
            <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:44,letterSpacing:2,color:"#fff",marginBottom:10}}>
              IRON VAULT<br/><span style={{color:"#AAFF00"}}>ACADEMY</span>
            </div>
            <p style={{fontSize:14,color:"#555",lineHeight:1.7,marginBottom:28}}>
              Sign in to access your purchased modules and continue learning.
            </p>
            <button
              style={{width:"100%",background:"#AAFF00",border:"none",borderRadius:3,padding:16,color:"#080808",fontFamily:"'Bebas Neue',sans-serif",fontSize:18,letterSpacing:2,cursor:"pointer",marginBottom:12}}
              onClick={login}
            >
              SIGN IN → CONTINUE
            </button>
            <Link href="/learn/pay" style={{display:"block",fontFamily:"'Space Mono',monospace",fontSize:10,letterSpacing:2,color:"#555",textDecoration:"none"}}>
              NEW? VIEW PRICING →
            </Link>
          </div>
        </div>
    ...
    return(
      <div className="iv">
        ...
        <div style={{minHeight:"100vh",display:"grid",placeItems:"center",position:"relative",zIndex:1}}>
          <div style={{fontFamily:"'Space Mono',monospace",fontSize:10,letterSpacing:3,color:"#AAFF00"}}>▸ VERIFYING ACCESS...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="iv">
        ...
        <div className="iv-hub">
          <div className="iv-wrap">
            <div className="iv-eyebrow">▸ IRON VAULT ACADEMY</div>
            <h1 className="iv-h1">Your Vault<br/>Dashboard</h1>
            <p className="iv-sub">Complete each module and pass the quiz at 8/10 to unlock the next level. Unlock additional modules to continue your education.</p>
            ...
            <div className="iv-grid">
              {MODULES.map((mod,i)=>{
                ...
                const canClick = st !== "buy" && st !== "locked";
                return(
                  <div key={mod.id}
                    className={`iv-card ${st==="locked"?"locked":""} ${st==="buy"?"locked purchasable":""} ${st==="passed"?"passed":""}`}
                    style={{animationDelay:`${i*0.07}s`}}
                    onClick={()=>{ if(canClick){setModIdx(i);setView("module");} }}>
                    <div className="iv-card-hd">
                      ...
                      <div className={`iv-badge ${
                        ...
                        st==="locked"?"b-lock":
                        st==="passed"?"b-pass":
                        st==="progress"?"b-prog":"b-avail"
                      }`}>
                        {st==="buy"?`UNLOCK — $${MODULE_PRICES[mod.id]}`:
                         st==="locked"?"🔒 COMPLETE PREVIOUS":
                         st==="passed"?"✓ PASSED":
                         st==="progress"?"● IN PROGRESS":"▶ AVAILABLE"}
                      </div>
                    </div>
                    ...
                    {st==="buy"&&(
                      <Link
                        href={`/learn/pay?module=${mod.id}`}
                        className="iv-unlock-cta"
                        onClick={e=>e.stopPropagation()}
                      >
                        UNLOCK MODULE {mod.id} — ${MODULE_PRICES[mod.id]}
                      </Link>
                    )}
                  </div>
                );
  ...
  if(view==="results"){
    ...
    const nextOwned=hasNext && isOwned(modIdx+1);
    return(
      <div className="iv">
        <style>{CSS}</style>
        ...
        <div className="iv-results">
          ...
          <p className="iv-results-sub">
            {passed
              ...
              : `${score}/10 — need ${PASS_SCORE} to pass. Review the lessons and try again.`}
          </p>
          {passed&&<div className="iv-results-xp">⚡ +{mod.xpReward} XP EARNED</div>}
          {passed&&hasNext&&!nextOwned&&(
            <div style={{marginBottom:24,padding:"20px 24px",background:"rgba(201,162,39,0.06)",border:"1px solid rgba(201,162,39,0.25)",borderRadius:4,textAlign:"left"}}>
              <div style={{fontFamily:"'Space Mono',monospace",fontSize:9,letterSpacing:2,color:"#C9A227",marginBottom:8}}>▸ CONTINUE YOUR EDUCATION</div>
              <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:22,color:"#fff",marginBottom:6}}>Module {modIdx+2}: {MODULES[modIdx+1].title}</div>
              <p style={{fontSize:13,color:"#555",lineHeight:1.6,marginBottom:14}}>{MODULES[modIdx+1].subtitle}</p>
              <Link href={`/learn/pay?module=${modIdx+2}`} style={{display:"inline-block",background:"#AAFF00",border:"none",borderRadius:3,padding:"12px 24px",color:"#080808",fontFamily:"'Bebas Neue',sans-serif",fontSize:15,letterSpacing:2,cursor:"pointer",textDecoration:"none"}}>
                UNLOCK MODULE {modIdx+2} — ${MODULE_PRICES[MODULES[modIdx+1].id]}
              </Link>
            </div>
          )}
          <div className="iv-results-btns">
            ...
            <button className="iv-btn-lime" onClick={()=>{
              if(passed&&hasNext&&nextOwned){setModIdx(m=>m+1);setView("module");}
              else setView("hub");
            }}>
              {passed&&hasNext&&nextOwned?`NEXT: ${MODULES[modIdx+1].tag} →`:"BACK TO DASHBOARD"}
            </button>
          </div>
        </div>
      </div>
